...
DEMO_MODE_NOTICE = (
    "> _Generated in **demo mode** (no `OPENAI_API_KEY` found) using"
    " deterministic keyword matching, not an LLM. Set that environment"
    " variable for genuinely tailored, freshly written content._"
)
